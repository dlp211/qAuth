...
import qauth.djd.qauthclient.login.common.view.SlidingTabLayout;

/**
 * A basic sample which shows how to use {@link qauth.djd.qauthclient.login.common.view.SlidingTabLayout}
